      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4">
            <button
              onClick={retry}
              className="rounded bg-red-600 px-3 py-1 text-sm text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none"
            >
              Try Again
            </button>
          </div>
    ...
    <div className="rounded-lg border border-orange-200 bg-orange-50 p-6 dark:border-orange-800 dark:bg-orange-900/20">
      <div className="text-center">
        ...
        <p className="mt-1 text-sm text-orange-700 dark:text-orange-300">
          The activity heatmap couldn't be loaded. This might be due to missing data or a library
          issue.
        </p>
    ...
    <div className="rounded-lg border border-purple-200 bg-purple-50 p-6 dark:border-purple-800 dark:bg-purple-900/20">
      <div className="text-center">
        ...
        <p className="mt-1 text-sm text-purple-700 dark:text-purple-300">
          The tag treemap couldn't be loaded. This might be due to missing tag data or a rendering
          issue.
        </p>
        <div className="mt-4 space-x-2">
          <button
    ...
    <noscript>
      <div className="rounded-lg border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h4 className="mb-2 font-medium text-gray-900 dark:text-gray-100">Recent Activity</h4>
          ...
          <div>
            <h4 className="mb-2 font-medium text-gray-900 dark:text-gray-100">Popular Topics</h4>
            <div className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4">
            <button
              onClick={retry}
              className="rounded bg-yellow-600 px-3 py-1 text-sm text-white hover:bg-yellow-700 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:outline-none"
            >
              Try Again
            </button>
          </div>
