...
![alt text](/static/images/container-vs-vm-inline1_tcm19-82163.png.avif)
...
![](/static/images/pod_and_container.png)
...
然后`kubectl apply -f deploy/nginx_deployment.yaml`部署，可以看到结果：![](/static/images/deployment.png)

你还可以查看 minikube 提供的 Web Console 进行可视化管理：

![alt text](/static/images/CleanShot 2024-06-22 at 10.02.51.png)
